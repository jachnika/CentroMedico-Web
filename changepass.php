			...
			?>
 			...
 			<center>
 				<?PHP
    				...
    				{
    					echo '
            			<FORM METHOD = "POST" ACTION="redirectafterchangepass.php" NAME = "FORMULARZ2">
            				<TABLE BORDER="0">
                				<TR>
                    				<TD>
                				...
                				<TR>
                    				...
                    				<TD>
                        				<INPUT TYPE="PASSWORD" VALUE="" NAME="CONFIRMEDNEWPASSWORD">
                    				</TD>
                				</TR>
                				<TR>
                    				<TD>
                						<INPUT TYPE="SUBMIT" VALUE="ZATWIERDŹ" NAME="ENTER">
                    				</TD>
                				</TR>
            				</TABLE>
            			</FORM>
